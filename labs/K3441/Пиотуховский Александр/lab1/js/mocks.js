/**
 * Пока без бэка, чтобы имитировать получение данных
 */
    ...
    return `
        <div class="recipe-card" data-recipe-id="${recipe.id}">
            <div class="recipe-image">
                <img src="https://placehold.co/350x250/ff6b6b/ffffff?text=${encodeURIComponent(recipe.title.substring(0, 20))}" alt="${recipe.title}">
            ...
            <div class="recipe-body">
                ...
                <div class="recipe-footer">
                    <div class="recipe-author">
                        <img src="${user?.photoUrl || 'https://placehold.co/32x32/999/fff?text=?'}" alt="${user?.username || 'User'}">
                        <span>${user?.firstName || 'Пользователь'} ${user?.lastName || ''}</span>
                    </div>
                    <div class="recipe-stats">
                        <span class="me-3">
                            <i class="bi bi-heart-fill text-danger"></i> ${Math.floor(Math.random() * 500 + 100)}
                        </span>
                        <span>
                            <i class="bi bi-chat-fill text-primary"></i> ${Math.floor(Math.random() * 100 + 10)}
                        </span>
                    </div>
                </div>
            </div>
