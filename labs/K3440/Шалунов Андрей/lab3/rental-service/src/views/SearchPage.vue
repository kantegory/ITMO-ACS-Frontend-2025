<template>
    <AppNavbar />
    <BaseLayout>
        <h1 class="h3 mb-3 d-flex align-items-center gap-2">Поиск недвижимости</h1>
        ...
        <div class="card card-body mb-3">
            <form class="row g-3" @submit.prevent="onApply">
                ...
                <div class="col-12 d-flex gap-2">
                    <button class="btn btn-primary" type="submit" :disabled="propsStore.loading">Применить</button>
        ...
        <div v-if="propsStore.loading" class="text-muted">Загружаем объявления...</div>

        <div v-else class="row g-3">
            <div v-if="propsStore.items.length === 0" class="text-muted">Объявлений не найдено.</div>
