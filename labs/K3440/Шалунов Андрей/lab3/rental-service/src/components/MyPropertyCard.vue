    ...
    <div class="card h-100 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="mt-auto d-flex gap-2">
                <RouterLink class="btn btn-outline-secondary btn-sm" :to="`/property/${property.property_id}`">
                    Открыть
                </RouterLink>

                <button class="btn btn-outline-primary btn-sm" type="button" @click="onEdit">Редактировать</button>
                <button class="btn btn-outline-danger btn-sm" type="button" @click="onDelete">Удалить</button>
            </div>
        </div>
    </div>
</template>
