...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsVacancyController_search: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.get('/vacancies',
            ...(fetchMiddlewares<RequestHandler>(VacancyController)),
            ...(fetchMiddlewares<RequestHandler>(VacancyController.prototype.search)),

            async function VacancyController_search(request: ExRequest, response: ExResponse, next: any) {
            ...
            try {
                ...
                const controller: any = await container.get<VacancyController>(VacancyController);
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsVacancyController_detail: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
        };
        app.get('/vacancies/:id',
            ...(fetchMiddlewares<RequestHandler>(VacancyController)),
            ...(fetchMiddlewares<RequestHandler>(VacancyController.prototype.detail)),

            async function VacancyController_detail(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsVacancyController_create: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/vacancies',
            ...
            ...(fetchMiddlewares<RequestHandler>(VacancyController)),
            ...(fetchMiddlewares<RequestHandler>(VacancyController.prototype.create)),

            async function VacancyController_create(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsVacancyController_update: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                dto: {"in":"body","name":"dto","required":true,"ref":"VacancyUpdateDto"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.patch('/vacancies/:id',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(VacancyController)),
            ...(fetchMiddlewares<RequestHandler>(VacancyController.prototype.update)),

            async function VacancyController_update(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsVacancyController_remove: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.delete('/vacancies/:id',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(VacancyController)),
            ...(fetchMiddlewares<RequestHandler>(VacancyController.prototype.remove)),

            async function VacancyController_remove(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsEmployerController_get: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/me/employer',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(EmployerController)),
            ...(fetchMiddlewares<RequestHandler>(EmployerController.prototype.get)),

            async function EmployerController_get(request: ExRequest, response: ExResponse, next: any) {
            ...
            try {
                ...
                const controller: any = await container.get<EmployerController>(EmployerController);
                if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
                }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsEmployerController_create: Record<string, TsoaRoute.ParameterSchema> = {
                dto: {"in":"body","name":"dto","required":true,"ref":"EmployerCreateDto"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.post('/me/employer',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(EmployerController)),
            ...(fetchMiddlewares<RequestHandler>(EmployerController.prototype.create)),

            async function EmployerController_create(request: ExRequest, response: ExResponse, next: any) {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsCompanyController_remove: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
        };
        app.delete('/companies/:id',
            ...(fetchMiddlewares<RequestHandler>(CompanyController)),
            ...(fetchMiddlewares<RequestHandler>(CompanyController.prototype.remove)),

            async function CompanyController_remove(request: ExRequest, response: ExResponse, next: any) {
