<template>
    ...
    <BaseLayout>
        ...
        <div v-if="store.loading" class="text-muted">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <span class="fw-semibold">{{ deleteTitle }}</span>?
                        </div>
...
async function confirmDelete() {
    if (!ownerId.value || !deleteId.value) {
        return;
    }
...
onMounted(async () => {
    ...
    if (ownerId.value) {
        await store.loadMine(ownerId.value);
    }
});

watch(ownerId, async (val) => {
    if (val) {
        await store.loadMine(val);
    }
});
</script>